...
interface NavStackedAreaChartProps {
  data: ChartDataPoint[];
  assets: string[];
  height?: number;
}
    ...
    return (
      <div className="rounded border border-gray-200 bg-white p-3 shadow-lg">
        ...
        <p className="mb-2 text-sm font-medium text-gray-700">
          Total: {formatCurrencyInMillions(total)}
        </p>
...
export default function NavStackedAreaChart({
  data,
  assets,
  height = 400,
}: NavStackedAreaChartProps) {
  ...
  return (
    <div className="w-full">
      <h3 className="mb-4 text-lg font-semibold">
        NAV Evolution - Stacked Area Chart (BRL)
      </h3>
