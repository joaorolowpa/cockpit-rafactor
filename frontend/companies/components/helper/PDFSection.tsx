...
import { CompanyPdf } from "@/components/forms/old/CompanyPdf";
...
const PDFSection: React.FC<PDFSectionProps> = ({
  ...
  const handleAddClick = () => setIsOpenSheet(true);
  ...
  const handleDownload = (filePath: string) => {
    ...
    const queryParams = { user_id: userId, datalake_filepath: filePath };
      ...
      >
        <div className="min-w-0 flex-1">
          <div className="flex items-start gap-x-3">
            ...
            {item.documentType && (
              <span className="mt-0.5 rounded-md bg-green-50 px-1.5 py-0.5 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
